## Documentation
***Disclamer:*** **This documentation is a technical documentation about the messages database. It is recommended to refer to the administrator manual for more general documentation (See [report.pdf](report.pdf)).**
